...
public class BookListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //SearchView svSearch = (SearchView) findViewById(R.id.action_search);
    ...
    public void launchDetailView(int position) {
        Intent i = new Intent(BookListActivity.this, BookDetailActivity.class);
        Book book = (Book) lvBooks.getItemAtPosition(position);
